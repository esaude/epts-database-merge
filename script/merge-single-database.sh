...
FULL_FILE_NAME=$1
DATABASE_NAME=$2
mysql -u$user -pAdmin123 -h$host -e "drop database if exists $DATABASE_NAME; create database $DATABASE_NAME;"
mysql -u$user -pAdmin123 -h$host $DATABASE_NAME < $FULL_FILE_NAME
